          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 10),
                Text(
                  "如你所见，语燕的开发并不是很完整，包括几大类型的知识库，画板，讨论区看板这些都是未完成的部分，以及详细文档页面是在是太太太丑了，有时还会出现一些html的代码，那是因为使用了第三方库且没有做足够优化的原因，再加上有许多其他项目需要更进，网课作业也天天被催…… 因此，我们强烈希望有兴趣的设计师/开发者加入项目的开发和维护，技术文档在路上了，不久会公布在项目组的语雀知识库，感恩！ developlove@vip.qq.com",
                  style: AppStyles.textStyleBC,
                ),
                SizedBox(height: 120),
              ],
