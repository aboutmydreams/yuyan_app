class SearchGroupJson {
  SearchGroupData data;

  SearchGroupJson({this.data});

  SearchGroupJson.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null
        ? new SearchGroupData.fromJson(json['data'])
        : null;
  }
...
class SearchGroupData {
  ...
  SearchGroupData({this.type, this.hits, this.totalHits, this.numHits});

  SearchGroupData.fromJson(Map<String, dynamic> json) {
    type = json['type'];
    if (json['hits'] != null) {
      hits = new List<Hits>();
      json['hits'].forEach((v) {
